...
package org.geomesa.example.accumulo;
...
public class AccumuloQuickStart extends GeoMesaQuickStart {

    // use gdelt data
    private QuickStartData data = new GDELTData();

    public AccumuloQuickStart(Map<String, String> params) {
        super(params);
    }

    public AccumuloQuickStart(String[] args)  throws ParseException {
    ...
    public static void main(String[] args) {
        try {
            new AccumuloQuickStart(args).run();
